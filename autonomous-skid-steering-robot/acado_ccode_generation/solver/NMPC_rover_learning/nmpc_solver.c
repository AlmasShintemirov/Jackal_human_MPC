...
nmpcWorkspace.state[56] = nmpcVariables.od[lRun1 * 2];
nmpcWorkspace.state[57] = nmpcVariables.od[lRun1 * 2 + 1];
...
nmpcWorkspace.objValueIn[8] = nmpcVariables.od[runObj * 2];
nmpcWorkspace.objValueIn[9] = nmpcVariables.od[runObj * 2 + 1];
...
nmpcWorkspace.objValueIn[6] = nmpcVariables.od[60];
nmpcWorkspace.objValueIn[7] = nmpcVariables.od[61];
...
nmpcWorkspace.state[56] = nmpcVariables.od[index * 2];
nmpcWorkspace.state[57] = nmpcVariables.od[index * 2 + 1];
...
nmpcWorkspace.state[56] = nmpcVariables.od[60];
nmpcWorkspace.state[57] = nmpcVariables.od[61];
...
nmpcWorkspace.objValueIn[8] = nmpcVariables.od[lRun1 * 2];
nmpcWorkspace.objValueIn[9] = nmpcVariables.od[lRun1 * 2 + 1];
