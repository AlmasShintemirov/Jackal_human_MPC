...
int main(int argc, char* argv[])
{
    ...
    while (ros::ok())
    {
        ...
        //        else if (!traj_input_struct.traj_on_switch && traj_input_struct.traj_num != 0)
        //        {
        //            if (trajectory->traj_started_flag)
        //            {
        //                trajectory->setReferencePositionToLast();
        //                trajectory->traj_started_flag = false;
        //            }
        //            if (trajectory->print_flag_traj_started == 0)
        //            {
        //                ROS_INFO("---------------------------------");
        //                ROS_INFO("Holding reference position!");
        ...
        //                ROS_INFO("Heading reference =  %.2f deg!", trajectory->getHeading());
        //                trajectory->print_flag_traj_started = 1;
        //            }
        //        }
        else
        {
            if (!trajectory->reset_done_flag)
                trajectory->reset(traj_input_struct);  // reset only when the reference is set at origin
