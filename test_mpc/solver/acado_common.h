...
/** Matrix of size: 4 x 77 (row major format) */
real_t rk_kkk[ 308 ];
...
/** Row vector of size: 110 */
real_t objValueOut[ 110 ];
...
/** Matrix of size: 97 x 97 (row major format) */
real_t H[ 9409 ];

/** Matrix of size: 180 x 97 (row major format) */
real_t A[ 17460 ];
